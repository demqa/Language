...
int EmitStdLib(Backend *back)
{
    ...
    {
        0xb8, 0x0, 0x0, 0x0, 0x0, 0xbf, 0x0, 0x0, 0x0, 0x0, 0x4c, 0x89, 0xfe, 0xba, 0xa,
    ...
    {
        0x4c, 0x89, 0xff, 0x48, 0x89, 0xc3, 0xe8, 0x10, 0x0, 0x0, 0x0, 0x4c, 0x89, 0xfe, 0xb8, 0x1, 0x0, 0x0, 0x0, 0xbf, 0x1, 0x0, 0x0, 0x0, 0xf, 0x5, 0xc3, 0x48, 0x89, 0xfe, 0xb9, 0xa,
...
int EmitLabels(Backend *back)
{
    ...
    while (elem)
    {
        ...
        *((int32_t *) (back->code_buff + dst_offset)) = src_offset - dst_offset - arg_offset;
